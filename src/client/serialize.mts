import { getContentType, getDevice, isJidBroadcast, isJidGroup, normalizeMessageContent, WAMessage, WASocket } from "baileys";
import { downloadMessage, getConfig, toJid, detectType, Message } from "#default";
